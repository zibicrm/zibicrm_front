                    ...
                    <div className="px-1 py-1 ">
                      <Menu.Item>
                        {({ active }) => (
                          <button
                            onClick={() =>
                              router.push("/operator/appointment/add")
                            }
                      ...
                      <Menu.Item>
                        {({ active }) => (
                          <button
                            onClick={() =>
                              router.push("/operator/appointment/add-surgery")
                            }
                            className="py-2"
                          >
                            نوبت جراحی
              ...
              {filterData &&
                filterData.map((item, index) => (
                  <tr
                    ...
                    onClick={() =>
                      router.push(
                        `/operator/record/detail/?id=${item.document_id}`
                      )
                    }
                  >
                    ...
                    >
                      {item.status === 1 ? (
                        <IconBtn
                          icon={
                            <div className="relative text-2xl text-gray-900">
                              <MdCalendarToday />
                              <span className="text-[16px] text-gray-900 absolute bg-white -bottom-0.5 -right-0.5">
                                <MdOutlineCancel />
                              </span>
                            </div>
                          }
