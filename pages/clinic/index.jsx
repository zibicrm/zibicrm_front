  ...
  return (
    <Layout>
      ...
      <div className="flex flex-col w-full min-h-[500px] items-center gap-6 shadow-cs p-4">
          <TimelineCalendar access="clinic"/>
        </div>
                  ...
                  >
                    ...
                    <div className="flex flex-row items-center gap-2">
                      ...
                      <IconBtn
                        ...
                        onClick={() =>
                          router.push(
                            `/clinic/record/detail/?id=${item.document.id}`
                          )
                        }
                      />
                    </div>
        ...
        <div className="grid grid-cols-10 gap-3">
          <div className="col-span-6 flex flex-col items-center gap-4 p-6 h-full shadow-cs rounded-cs">
            <div className="w-full flex items-center justify-between">
              <span className="text-gray-900">تحویل های لابراتوار</span>
            </div>
                ...
                <tbody className="overflow-y-auto w-full min-h-[400px] ">
                  {threeTable &&
                    threeTable.map((item, index) => (
                      <tr
                        key={item.id}
                        className="h-12 text-sm text-gray-900 font-normal hover:bg-primary-50"
                      >
          ...
          <div className="col-span-4 h-full p-6 flex flex-col items-start gap-4 rounded-cs shadow-cs ">
            ...
            <div className="flex w-full flex-col items-center gap-4 max-h-full overflow-y-auto">
              {followUpDelivery.map((item) => (
                <div
                  key={item.id}
                  className="flex text-gray-900 w-full h-8 flex-row items-center justify-between"
                >
