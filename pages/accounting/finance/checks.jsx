  ...
  return (
    <Layout>
      <div className="z-0 ">
        ...
        <div className="w-full flex flex-row items-center justify-between px-6 py-4 h-20">
          <div className="w-[40%]">
            <SearchBox
              allData={records}
        ...
        <div className="w-full max-w-full overflow-x-scroll overflow-y-scroll z-10 h-[calc(100vh-295px)]">
                ...
                filterData.record.map((item, index) => (
                  <>
                    <tr className="h-12 relative text-sm text-gray-600 hover:bg-primary-50 duration-100">
                      ...
                      {popover === item.id ? (
                        <div className="absolute  bg-white rounded-cs shadow-btn w-fit left-16 top-5 z-50">
                          <div className=" flex flex-col items-center ">
                            <Link
                              href={`/accounting/record/detail/?id=${item.document.id}`}
                            >
                              <a
