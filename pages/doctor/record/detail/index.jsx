    ...
    const iconBoxList = [
      {
        ...
        text: "اطلاعات پرونده ",
        link: `/doctor/record/detail/edit/?id=${id}`,
        id: 0,
      },
      {
        icon: <MdOutlineAssignmentInd />,
        text: "ثبت درمان",
        link: `/doctor/record/detail/medical/?id=${id}`,
      ...
      //   text: "مدیریت مالی",
      //   link: `/doctor/record/detail/finance/?id=${id}`,
      //   id: 3,
      // },
      {
        icon: <MdChatBubbleOutline />,
        text: "ارسال پیامک",
        link: `/doctor/message/?id=${id}&name=${data && data.name}`,
        id: 5,
      },
    ];
