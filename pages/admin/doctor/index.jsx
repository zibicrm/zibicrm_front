...
const Doctor = () => {
  ...
  return (
    <Layout>
        ...
        <div className="w-full flex flex-row items-center justify-between px-6 py-4">
          ...
          <div className="flex flex-row items-center gap-3">
            ...
            <div className="w-32 h-12">
              <PrimaryBtn
                text="افزودن پزشک"
                onClick={() => router.push("/admin/doctor/add")}
              >
                  ...
                  >
                    ...
                    <td className=" text-right px-3 flex flex-row items-center justify-start text-base lg:text-xl gap-3 h-12 border-x border-gray-200">
                      <IconBtn
                        ...
                        onClick={() =>
                          router.push(
                            `/admin/doctor/detail/?id=${item.id}&clinic=${item.clinic_id}`
                          )
                        }
                      />
      ...
      {deleteAlert > 0 ? (
        <DeleteWarning
          deleteHandler={() => deleteHandler(deleteAlert)}
          setState={setDeleteAlert}
          title="حذف ساعت"
          text={`آیا از حذف پزشک ${doctorName} اطمینان دارید؟`}
        />
      ) : null}
    </Layout>
  );
