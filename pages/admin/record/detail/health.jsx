...
const EditRecord = () => {
  ...
  const initialValues = {
    ...
    service_id: "",
    count: "",
    clinic_id: data ? data.address_id : "",
  };
  ...
  const clinicFormik = useFormik({
    ...
    onSubmit: (values) => {
      ...
      transferRecordClinicService(
        { document_id: data.id, clinic_id: values.clinic_id },
        {
          Authorization: "Bearer " + user.token,
        }
      )
  ...
  return (
    <Layout>
      ...
      {formik && formik.values && formik.values.clinic_id === 7 && (
        <Modal>
          <div className="w-[508px] bg-white rounded-cs p-6 flex flex-col gap-y-4">
            ...
            >
              ...
              {latestAppointmentDetails.length > 0 && (
                ...
                {detailsLoading && <div className="flex items-center justify-center">
                  <LoadingBtn />
                  </div>}
              {latestAppointmentDetails.length > 0 && (
                      ...
                      <tbody className="overflow-y-auto ">
                        {latestAppointmentDetails.map((d, index) => (
                          ...
                          >
                           ...
                           { moment(d.dateOfDay)
                          .locale("fa")
                          .format("YYYY/MM/DD")} | {convertDay(d.day)}
                            </td>
                          </tr>
                        ))}
                      </tbody>
