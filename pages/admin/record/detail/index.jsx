  ...
  const iconBoxList = [
    {
      ...
      text: "اطلاعات پرونده ",
      link: `/admin/record/detail/edit/?id=${id}`,
      id: 0,
    },
    {
      icon: <MdOutlineAssignmentInd />,
      text: "ثبت درمان",
      link: `/admin/record/detail/medical/?id=${id}`,
      id: 1,
    },
    // {
    //   icon: <MdOutlineAssignment />,
    //   text: "طرح درمان",
    //   link: `/admin/record/detail/treatment-plan/?id=${id}`,
    //   id: 2,
    // },
    {
      icon: <BsCurrencyDollar />,
      text: "مدیریت مالی",
      link: `/admin/record/detail/finance/?id=${id}`,
      id: 3,
    },
    {
      icon: <MdOutlineChat />,
      text: "گفت و گو ها",
      link: `/admin/message/conversation/?id=${id}`,
      id: 4,
    },
    {
      icon: <MdChatBubbleOutline />,
      text: "ارسال پیامک",
      link: `/admin/message/?id=${id}&name=${data && data.name}`,
      id: 5,
    },
  ];
                    ...
                    {transaction &&
                      transaction.map((item, index) => (
                        ...
                        >
                          ...
                          <td className="  text-right px-3 border-x border-gray-200">
                            <button className="text-primary-900">مشاهده</button>
                          </td>
                          <td>
                            <IconBtn
      ...
      {/* {data && data.address_id === 7 && (
        <Modal>
          <div className="w-[508px] bg-white rounded-cs p-6 flex flex-col gap-y-4">
            ...
            <p className="text-sm">
              لطفا با توجه به اطلاعات نوبت های پیشین مشخص کنید بیمار مربوط به
              کدام مطب می باشد
            </p>
            <form
            ...
            >
              ...
              {latestAppointmentDetails.length > 0 && (
                <div className="border-b-2 border-primary-300 border-dashed"></div>
              )}
