...
const VisitTimelineCalendar = ({
  ...
  return (
    <div className="main-timeline2 border-l border-r border-gray-200 rounded-cs relative ">
        ...
        visitAppointments.map((appointment) => {
          return (
            <div key={appointment.id} className="grid-row-1 border-b">
              <div className="r relative min-h-[80px] border-l">
                    ...
                    return (
                      <div key={doctor.id} className="">
                        {doctor.days.map((day) => {
                          ...
                          let dvs = doctor.dv.find((dv) => dv.key === "DVT");
                          ...
                          //       let doctorStartHour3 =
                          //   day.times[2]?.start.split(":")[0];
                          // let doctorStartMin3 =
                          //   day.times[2]?.start.split(":")[1];
                          // let doctorStart3 = Number(
                          //   day.times[2]?.start.split(":")[0]
                          // );
                          // let doctorEnd3 =
                          //   Number(day.times[2]?.end.split(":")[0]) + 0.1;
                          // const length2 =
                          //   (doctorEnd2 - doctorStart2) /
                          //   ((appointment_time * (doctorEnd2 - doctorStart2)) /
                          //     ((doctorEnd2 - doctorStart2) * 60));
                          ...
                          let vip = doctor.appointment.filter(
                            (s) => s.vip !== null
                          );
                          ...
                          return (
                            <div key={day.id} className="relative w-full">
                              ...
                              <div className="timeline-times-grid2">
                                {array1.map((a, i) => {
                                        ...
                                        {ff?.reception === 2 && (
                                          <>
                                            ...
                                            ff.id === documentId ? (
                                              ...
                                              <>
                                                <span className="absolute top-3 right-0">
                                                  <MdOutlineDone className="text-green-700 w-3 h-3" />
                                                </span>
                                ...
                                {array2.map((a, i) => {
                                  ...
                                  return ff ? (
                                    ...
                                    <div
                                      ...
                                      key={a}
                                      className={`${aa && 'hidden'} bg-primary-100 w-full text-[11px] text-primary-900 font-light flex items-center justify-center whitespace-nowrap px-1 py-2 border border-primary-900 rounded-md cursor-pointer hover:text-white hover:bg-primary-700`}
                                    >
                                      <span className="-rotate-90">
                                        {startdate}
                                      </span>
...
export default VisitTimelineCalendar;
